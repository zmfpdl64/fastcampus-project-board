...
class ArticleControllerTest {
    ...
    @MockBean private PagenationService paginationService;
    ...
    private ArticleDto createArticleDto(String title, String content, Set<HashtagDto> hashtags) {
